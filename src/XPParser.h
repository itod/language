...
enum {
    ...
    XP_TOKEN_KIND_LT = 51,
    XP_TOKEN_KIND_THROW = 52,
    XP_TOKEN_KIND_EQUALS = 53,
    XP_TOKEN_KIND_TRY = 54,
    XP_TOKEN_KIND_GT = 55,
    XP_TOKEN_KIND_WHILE = 56,
    XP_TOKEN_KIND_IS = 57,
    XP_TOKEN_KIND_ELSE = 58,
    XP_TOKEN_KIND_NAN = 59,
    XP_TOKEN_KIND_DIVEQ = 60,
