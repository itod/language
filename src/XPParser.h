...
enum {
    ...
    XP_TOKEN_KIND_GT = 35,
    XP_TOKEN_KIND_OPEN_PAREN = 36,
    XP_TOKEN_KIND_WHILE = 37,
    XP_TOKEN_KIND_VAR = 38,
    XP_TOKEN_KIND_CLOSE_PAREN = 39,
    XP_TOKEN_KIND_DIVEQ = 40,
    XP_TOKEN_KIND_TIMES = 41,
    XP_TOKEN_KIND_OR = 42,
    XP_TOKEN_KIND_CAT = 43,
    XP_TOKEN_KIND_PLUS = 44,
    XP_TOKEN_KIND_NOT = 45,
    XP_TOKEN_KIND_OPEN_BRACKET = 46,
    XP_TOKEN_KIND_COMMA = 47,
    XP_TOKEN_KIND_AND = 48,
    XP_TOKEN_KIND_NULL = 49,
    XP_TOKEN_KIND_MINUS = 50,
    XP_TOKEN_KIND_IN = 51,
    XP_TOKEN_KIND_CLOSE_BRACKET = 52,
    XP_TOKEN_KIND_NAN = 53,
