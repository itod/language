...
enum {
    ...
    XP_TOKEN_KIND_GT = 39,
    XP_TOKEN_KIND_LINEFEED = 40,
    XP_TOKEN_KIND_OPEN_PAREN = 41,
    XP_TOKEN_KIND_WHILE = 42,
    XP_TOKEN_KIND_VAR = 43,
    XP_TOKEN_KIND_CLOSE_PAREN = 44,
    XP_TOKEN_KIND_DIVEQ = 45,
    XP_TOKEN_KIND_TIMES = 46,
    XP_TOKEN_KIND_OR = 47,
    XP_TOKEN_KIND_CAT = 48,
    XP_TOKEN_KIND_PLUS = 49,
    XP_TOKEN_KIND_NOT = 50,
    XP_TOKEN_KIND_OPEN_BRACKET = 51,
    XP_TOKEN_KIND_COMMA = 52,
    XP_TOKEN_KIND_AND = 53,
    XP_TOKEN_KIND_NULL = 54,
    XP_TOKEN_KIND_MINUS = 55,
    XP_TOKEN_KIND_IN = 56,
    XP_TOKEN_KIND_CLOSE_BRACKET = 57,
    XP_TOKEN_KIND_NAN = 58,
    XP_TOKEN_KIND_SHIFTLEFT = 59,
    XP_TOKEN_KIND_BITXOR = 60,
    XP_TOKEN_KIND_DIV = 61,
    XP_TOKEN_KIND_FALSE = 62,
    XP_TOKEN_KIND_SUB = 63,
    XP_TOKEN_KIND_LE = 64,
    XP_TOKEN_KIND_EQ = 65,
};
